...
#error "Vous devez definir la macro (#define) pour le sujet que vous implanter, quelques lignes au dessus de la macro affichant cette erreu)"

#endif
#endif

extern void *mem_heap; //variable globale stockant l'adresse de la zone (utile pour le shell)
